...
- [`qualtRics`](https://CRAN.R-project.org/package=qualtRics): Convenience functions to pull survey results straight into R using the Qualtrics API. (**package archived 2018-02-05**)
...
- [`rdhs`](https://github.com/OJWatson/rdhs): Management and analysis of [Demographic and Health Survey (DHS)](https://dhsprogram.com/data/available-datasets.cfm) data. Not on CRAN yet.
